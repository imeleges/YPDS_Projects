...
## Список проектов:  
- PROJ_01 "Исследование надёжности заёмщиков"  
- PROJ_02 "Исследование объявлений о продаже квартир в Санкт-Петербурге"  
- PROJ_03 "Определение перспективного тарифа для телеком-компании"
- PROJ_04 "Закономерности определяющие успешность игры"
- PROJ_05 "Рекомендация тарифов"
- PROJ_06 "Прогнозирование оттока клиентов «Бета-Банка»"
- PROJ_07 "Выбор региона для разработки новых нефтяных месторождений"
- PROJ_08 "Предсказание коэффициента восстановления золота из золотосодержащей руды"
- PROJ_09 "Разработка алгоритма для защиты данных"
- PROJ_10 "Построение модели определения стоимости автомобиля"
- PROJ_11 "Прогнозирование количества заказов такси на следующий час"
- PROJ_12 "Обучение модели классификации комментариев"
- PROJ_13 "Оптимизация производственных расходов для металлургического комбината"
